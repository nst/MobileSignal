/* Generated by RuntimeBrowser on iOS 4.3
...
@interface UIStatusBarServer : NSObject  {
    NSObject <UIStatusBarServerClient> *_statusBar;
    struct __CFRunLoopSource { } *_source;
}

@property(retain) NSObject <UIStatusBarServerClient> * statusBar;
...
- (void)dealloc;
- (void)setStatusBar:(NSObject <UIStatusBarServerClient> *)arg1;
